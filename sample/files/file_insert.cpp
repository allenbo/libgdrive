...
int main() {
    ...
    std::ifstream fin("file_insert.cpp");
    FileContent fc(fin, "text/plain");
    GFile file;
    file.set_title("file_insert.cpp");
    file.set_description("This is a sample source code of how to use allenbo/gdrive to insert a file to Google drive");
